...
import 'package:flutter/material.dart';
import 'package:greengentem/widgets/countdowntimer.dart';
                ...
                Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.fromLTRB(15, 10, 15, 10),
                      child: Text(
                          'Expected Product Collection : $EXPECTED_PRODUCT_COLLECTED',
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 20,
                            //fontWeight: FontWeight.bold
                ...
                Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.fromLTRB(15, 10, 15, 10),
                      child: Text(
                          'Expected Product Delivery : $EXPECTED_PRODUCT_DELIVERED',
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 20,
                            //fontWeight: FontWeight.bold
