                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.all(20),
                        child: Text(
                          "   A buyer(after registration and verification of the license) can go to the “Categories Page” where he/she can bid their price for the required product. Once the timeline for the bid is done, the lowest bidder wins and he/she can proceed with the payment to get the product delivered.",
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 20,
                          ),
