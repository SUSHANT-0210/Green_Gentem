    ...
    return Scaffold(
      ...
      body: Container(
          ...
          child: ListView(children: <Widget>[
            ...
            SizedBox(height: 40),
            Image(
              image: AssetImage("assets/images/collaborator1.png"),
              height: 100,
              width: 100,
            ),
            SizedBox(height: 20),
            Image(
                image: AssetImage("assets/images/collaborator2.png"),
                height: 100,
                width: 100),
            SizedBox(height: 20),
            Image(
                image: AssetImage("assets/images/collaborator3.png"),
                height: 100,
                width: 100),
            SizedBox(height: 20),
            Image(
                image: AssetImage("assets/images/collaborator4.png"),
                height: 100,
                width: 100),
            SizedBox(height: 20),
            Image(
                image: AssetImage("assets/images/collaborator5.png"),
                height: 100,
                width: 100),
            SizedBox(height: 20),
            Image(
                image: AssetImage("assets/images/collaborator6.png"),
                height: 100,
                width: 100),
            SizedBox(height: 20),
